const { SURFACE, STYLE, DISTANCE } = require("./constants");
...
function normalSkillData(thiz) {
  return [
    ...
    {
      double: { id: 200021, name: "左回り◎", passiveSpeed: 60 },
      normal: { id: 200022, name: "左回り○", passiveSpeed: 40 },
      conditions: {
        rotation: 2,
      },
    },
    {
      ...
      double: { id: 200011, name: "右回り◎", passiveSpeed: 60 },
      normal: { id: 200012, name: "右回り○", passiveSpeed: 40 },
      conditions: {
        rotation: 1,
      },
    },
    {
      normal: { name: "季節ウマ娘○", passiveSpeed: 40 },
      double: { name: "季節ウマ娘◎", passiveSpeed: 60 },
    ...
    {
      normal: { id: 200272, name: "おひとり様○", passiveSpeed: 60 },
      double: { id: 200271, name: "おひとり様◎", passiveSpeed: 80 },
    },
    {
      normal: { id: 200302, name: "伏兵○", passiveSpeed: 40 },
      double: { id: 200301, name: "伏兵◎", passiveSpeed: 60 },
    },
    {
      normal: { id: 200262, name: "外枠得意○", passiveSpeed: 40 },
      double: { id: 200261, name: "外枠得意◎", passiveSpeed: 60 },
      tooltip: "発動率44%として扱う(チャンピオンズミーティング基準)",
      triggerRate: 4.0 / 9,
    },
    {
      normal: { id: 201631, name: "シンパシー", passiveSpeed: 40 },
    },
    {
      normal: { id: 201641, name: "一匹狼", passiveSpeed: 40 },
    },
    {
      normal: { id: 200082, name: "札幌レース場○", passiveStamina: 40 },
      double: { id: 200081, name: "札幌レース場◎", passiveStamina: 60 },
      conditions: {
        track_id: 10001,
      },
    },
    {
      normal: { id: 200092, name: "函館レース場○", passiveStamina: 40 },
      double: { id: 200091, name: "函館レース場◎", passiveStamina: 60 },
      conditions: {
        track_id: 10002,
      },
    },
    {
      normal: { id: 200112, name: "新潟レース場○", passiveStamina: 40 },
      double: { id: 200111, name: "新潟レース場◎", passiveStamina: 60 },
      conditions: {
        track_id: 10003,
      },
    },
    {
      normal: { id: 200102, name: "福島レース場○", passiveStamina: 40 },
      double: { id: 200101, name: "福島レース場◎", passiveStamina: 60 },
      conditions: {
        track_id: 10004,
      },
    },
    {
      normal: { id: 200042, name: "中山レース場○", passiveStamina: 40 },
      double: { id: 200041, name: "中山レース場◎", passiveStamina: 60 },
      conditions: {
        track_id: 10005,
      },
    },
    {
      normal: { id: 200032, name: "東京レース場○", passiveStamina: 40 },
      double: { id: 200031, name: "東京レース場◎", passiveStamina: 60 },
      conditions: {
        track_id: 10006,
      },
    },
    {
      normal: { id: 200072, name: "中京レース場○", passiveStamina: 40 },
      double: { id: 200071, name: "中京レース場◎", passiveStamina: 60 },
      conditions: {
        track_id: 10007,
      },
    },
    {
      normal: { id: 200062, name: "京都レース場○", passiveStamina: 40 },
      double: { id: 200061, name: "京都レース場◎", passiveStamina: 60 },
      conditions: {
        track_id: 10008,
      },
    },
    {
      normal: { id: 200052, name: "阪神レース場○", passiveStamina: 40 },
      double: { id: 200051, name: "阪神レース場◎", passiveStamina: 60 },
      conditions: {
        track_id: 10009,
      },
    },
    {
      normal: { id: 200122, name: "小倉レース場○", passiveStamina: 40 },
      double: { id: 200121, name: "小倉レース場◎", passiveStamina: 60 },
      conditions: {
        track_id: 10010,
      },
    },
    {
      normal: { id: 200952, name: "大井レース場○", passiveStamina: 40 },
      double: { id: 200951, name: "大井レース場◎", passiveStamina: 60 },
      conditions: {
        track_id: 10011,
      },
    },
    {
      normal: { id: 200132, name: "根幹距離○", passiveStamina: 40 },
      double: { id: 200131, name: "根幹距離◎", passiveStamina: 60 },
      conditions: {
        is_basis_distance: 1,
      },
    },
    {
      normal: { id: 200142, name: "非根幹距離○", passiveStamina: 40 },
      double: { id: 200141, name: "非根幹距離◎", passiveStamina: 60 },
      conditions: {
        is_basis_distance: 0,
      },
    },
    {
      normal: { id: 200152, name: "良バ場○", passivePower: 40 },
      double: { id: 200151, name: "良バ場◎", passivePower: 60 },
      rare: {
        id: 200154,
        name: "良バ場の鬼",
        passivePower: 60,
    ...
    {
      normal: { id: 200162, name: "道悪○", passivePower: 40 },
      double: { id: 200161, name: "道悪◎", passivePower: 60 },
      conditions: {
        ground_condition: [2, 3, 4],
      },
    },
    {
      normal: { id: 200282, name: "対抗意識○", passivePower: 40 },
      double: { id: 200281, name: "対抗意識◎", passivePower: 60 },
    },
    {
      normal: { name: "天気の日○", value: 40 },
      double: { name: "天気の日◎", value: 60 },
      status: ["guts"],
      emulatorTypeLimit: ["cm"],
      check: function () {
        return thiz.emulatorType === "cm";
    ...
    },
    {
      ...
      double: { id: 200291, name: "徹底マーク◎", value: 60 },
      status: ["guts"],
      check: function () {
        return true;
      },
    },
    {
      ...
      double: { id: 200251, name: "内枠得意◎", value: 60 },
      status: ["wisdom"],
    ...
    },
    {
      ...
      double: { id: 201521, name: "逃げのコツ◎", value: 60 },
      status: ["wisdom"],
      styleLimit: [1],
      check: function () {
    ...
    },
    {
      ...
      double: { id: 201531, name: "先行のコツ◎", value: 60 },
      status: ["wisdom"],
      styleLimit: [2],
      check: function () {
    ...
    },
    {
      ...
      double: { id: 201541, name: "差しのコツ◎", value: 60 },
      status: ["wisdom"],
      styleLimit: [3],
      check: function () {
    ...
    },
    {
      ...
      double: { id: 201551, name: "追込のコツ◎", value: 60 },
      status: ["wisdom"],
      styleLimit: [4],
      check: function () {
    ...
    },
    {
      ...
      check: function (startPosition) {
        return (
          thiz.isRunningStyle(2) && thiz.isInRandom(this.randoms, startPosition)
        );
      },
    },
    {
    ...
    },
    {
      ...
      check: function (startPosition) {
        return (
          thiz.isDistanceType(1) && thiz.isInRandom(this.randoms, startPosition)
        );
      },
    },
    {
      ...
      check: function (startPosition) {
        return (
          thiz.isDistanceType(4) && thiz.isInRandom(this.randoms, startPosition)
        );
      },
    },
    {
      ...
      check: function (startPosition) {
        return (
          thiz.isDistanceType(3) && thiz.isInRandom(this.randoms, startPosition)
        );
      },
    },
    {
      ...
      check: function (startPosition) {
        return (
          thiz.isRunningStyle(4) && thiz.isInRandom(this.randoms, startPosition)
        );
      },
    },
    {
    ...
    },
    {
      ...
      check: function (startPosition) {
        return (
          thiz.isDistanceType(2) && thiz.isInRandom(this.randoms, startPosition)
        );
      },
    },
    {
      ...
      check: function (startPosition) {
        return (
          thiz.isRunningStyle(3) && thiz.isInRandom(this.randoms, startPosition)
        );
      },
    },
    {
    ...
    },
    {
      ...
      check: function (startPosition) {
        return (
          thiz.isRunningStyle(1) && thiz.isInRandom(this.randoms, startPosition)
        );
      },
    },
    {
    ...
    },
    {
      ...
      check: function (startPosition) {
        return (
          thiz.accTimePassed(10) && thiz.isInRandom(this.randoms, startPosition)
        );
      },
    },
    {
